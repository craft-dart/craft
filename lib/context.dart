...
library craft_analyzer.context;
...
///
/// The [sdkPath] points to the installed location of the Dart SDK.
AnalysisContext analysisContext({Uri sdkPath}) {
  ...
  final sdk = new FolderBasedDartSdk(
      resourceProvider, resourceProvider.getFolder(sdkFilePath));

  // Using the .packages file
  final pubPackageMapProvider =
      new PubPackageMapProvider(PhysicalResourceProvider.INSTANCE, sdk);

  final packageMapInfo = pubPackageMapProvider.computePackageMap(
      PhysicalResourceProvider.INSTANCE.getResource('.') as Folder);
